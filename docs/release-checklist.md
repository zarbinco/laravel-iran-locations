...
- Confirm `config/iran-locations.php`, Persian `README.md`, English `README.en.md`, `docs/data.md`, and the data manifest all agree on data version and dataset counts.
