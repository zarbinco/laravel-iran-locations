...
class CityArea extends Model
{
    ...
    protected string $tableConfigKey = 'city_areas';
    ...
    {
        return $this->belongsTo(config('iran-locations.models.city_region'), 'city_region_id');
    }

    public function neighborhoods(): HasMany
    {
        return $this->hasMany(config('iran-locations.models.neighborhood'), 'default_city_area_id');
    }
}
