...
class Neighborhood extends Model
{
    ...
    protected string $tableConfigKey = 'neighborhoods';
    ...
    {
        return $this->belongsTo(config('iran-locations.models.city_region'), 'default_city_region_id');
    }

    public function defaultArea(): BelongsTo
    {
        return $this->belongsTo(config('iran-locations.models.city_area'), 'default_city_area_id');
    }

    public function regions(): BelongsToMany
    {
        return $this->belongsToMany(
            config('iran-locations.models.city_region'),
